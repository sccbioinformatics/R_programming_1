...
***Exercise:*** Using subsetting we learnt about earlier, make three new matrices called `lthsc`, `mep` and `gmp` to separate the cell types shown in the headings. For this look at the help page for a function called `grep`.
